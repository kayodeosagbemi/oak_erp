...
if (isset($_POST['btnSignin']))
{
  ...
  $pwd=$_POST['password'];
//  echo "<b>$usr $pwd</b>";
//  $isAuthenticated = model\User::isAuthenticated($usr, $pwd);
    ...
    <div class="container body">
      <div class="main_container">
        <div class="col-md-3 left_col">
          <div class="left_col scroll-view">
            <div class="navbar nav_title" style="border: 0;">
              <a href="index.php" class="site_title"><i class="fa fa-paw"></i> <span>Oak ERP!</span></a>
            </div>
              ...
              <ul class="nav navbar-nav navbar-right">
                <li class="">
                  <a href="javascript:;" class="user-profile dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
                    <img src="images/img.jpg" alt=""><?php echo $foundUser->getSurname() . " " . $foundUser->getMiddlename() . " " . $foundUser->getFirstname(); ?>
        ...
        <div class="right_col" role="main">
          ...
          <!--If the Role ID is an admin role id Show the Total users -->
          <?php if ($foundUser->getRoleId() == 1) { ?>
            <div class="col-md-2 col-sm-4 col-xs-6 tile_stats_count">
              <span class="count_top"><i class="fa fa-user"></i> Total Users</span>
              <div class="count"><!--2500--><?php echo count(User::getAllUsers());?></div>
              <!-- <span class="count_bottom"><i class="green">4% </i> From last Week</span> -->
            </div>
          <?php } //End of if RoleId== 1 (admin) ?>
            <!-- 
            <div class="col-md-2 col-sm-4 col-xs-6 tile_stats_count">
            ...
            -->
            <div class="col-md-2 col-sm-4 col-xs-6 tile_stats_count">
              <span class="count_top"><i class="fa fa-user"></i> Investors</span>
              <div class="count"><?php echo Investor::getTotalNumber(); ?></div>
              <span class="count_bottom"><i class="green"><i class="fa fa-sort-asc"></i>34% </i> From last Week</span>
            </div>
            <div class="col-md-2 col-sm-4 col-xs-6 tile_stats_count">
              <span class="count_top"><i class="fa fa-user"></i> Investments</span>
              <div class="count"><?php echo Investment::getTotalNumber(); ?></div>
              <span class="count_bottom"><i class="green"><i class="fa fa-sort-asc"></i>34% </i> From last Week</span>
            </div>
            <div class="col-md-2 col-sm-4 col-xs-6 tile_stats_count">
            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
              <div class="dashboard_graph">
                ...
                <div class="col-md-3 col-sm-3 col-xs-12 bg-white">
                  <div class="x_title">
                    <h2>Investment Plan Performance</h2>
                    <div class="clearfix"></div>
                  </div>
